                ...
                if ent.wts(view_matrix) and ent.health > 0 and not ent.dormant:
                    ...
                    if ent.team != 2 and kom == 'kt':
                        ...
                        if keyboard.is_pressed(aim):
                            if 1010 > x > 910:                 
                                if y > thenter_y < (y + y_aim) - y_aim / 7 and y < 580 :
                                     win32api.mouse_event(win32con.MOUSEEVENTF_MOVE, 0, 1, 0, 0)
                                elif y < thenter_y > (y + y_aim) - y_aim / 7 and 500 < (y + y_aim) - y_aim / 7 :
                                     win32api.mouse_event(win32con.MOUSEEVENTF_MOVE, 0, -1, 0, 0)

                            if 580 > y > 500:                 
                                if x + (x2 / 4) > thenter_x < (x + x2) - x2 / 4 and x + (x2 / 4) < 1010:
                                     win32api.mouse_event(win32con.MOUSEEVENTF_MOVE, 1, 0, 0, 0) 
                                elif x + (x2 / 4) < thenter_x > (x + x2) - x2 / 4 and 910 < (x + x2) - x2 / 4:
                                     win32api.mouse_event(win32con.MOUSEEVENTF_MOVE, -1, 0, 0, 0)
                    ...
                    if ent.team == 2 and kom == 't':
                        ...
                        if keyboard.is_pressed(aim):
                            if 1010 > x > 910:                 
                                if y > 540 < (y + y_aim) - y_aim / 7 and y < 580 :
                                     win32api.mouse_event(win32con.MOUSEEVENTF_MOVE, 0, 1, 0, 0)
                                elif y < 540 > (y + y_aim) - y_aim / 7 and 500 < (y + y_aim) - y_aim / 7 :
                                     win32api.mouse_event(win32con.MOUSEEVENTF_MOVE, 0, -1, 0, 0)
